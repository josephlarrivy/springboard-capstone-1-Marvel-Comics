...
spell_corrector = [
    ...
    ('Captain Marvel (Carol Danvers)',
        ['Captain Marvel', 'Carol Danvers', 'Captainmarvel', 'Captain-marlvel', 'Captain-Marvel']),
    ('Ironheart (Riri Williams)',
        ['Ironheart', 'Iron Heart', 'Iron-heart', 'iron-heart', 'ironheart']),
    ('Iron Man',
        ['Iron Man', 'Ironman', 'Iron-man', 'Tony Stark']),
    ('Spider-Man (Peter Parker)',
        ['Spider-Man', 'spiderman', 'Spider-Man', 'spider-man', 'spidey', 'Spiderman', 'peter parker', 'Peter Parker']),
    ('War Machine (James Rhodes)',
        ['War Machine', 'Warmachine', 'War-machine', 'James Rhodes']),
    ('Quake (Daisy Johnson)',
        ['Quake', 'Daisy Johnson']),
    ('Ms. Marvel (Kamala Khan)',
        ['Ms Marvel', 'Miss Marvel', 'Missmarvel', 'Mrs Marvel', 'Miss-marvel', 'Miss-Marvel']),
    ('Guardians Of The Galaxy',
        ['Guardians Of The Galaxy', 'Guardians Galaxy', 'guardians of the galaxy']),
    ('Avengers',
        ['Avengers', 'The Avengers']),
    ('Star-Lord (Peter Quill)',
        ['Star Lord', 'star lord', 'starlord', 'Peter Quill', 'peter quill']),
    ('Tiger Shark',
        ['Tiger Shark', 'tiger shark', 'tiger-shark', 'Tiger-shark', 'tiger-shark']),
    ('Black Panther',
        ['Black Panther', 'black panther', 'Blackpanther', 'blackpanther', 'Black-panther', 'black-panther']),
    ('Shocker (Herman Schultz)',
        ['shocker', 'Shocker', 'Herman Schults', 'herman schults']),
    ('Dani Moonstar',
        ['Dani Moonstar', 'Moonstar']),
    ('Quasar (Wendell Vaughn)',
        ['Quasar', 'Quassar', 'Wendell Vaugn', 'wendell vaughn']),
    ('Doctor Strange',
        ['Doctor Strange', 'doctor strange', 'doctor-stange', 'Doctor-strange']),
    ('Quasar (Phyla-Vell)',
        ['Quasar', 'quasar', 'quaasar', 'Phyla-Vell', 'Phyla-vell']),
    ('Doctor Doom',
